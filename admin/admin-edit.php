                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Admin Edit </h2>
                                ...
                                <form method="post" action="" id="validationform" data-parsley-validate="" novalidate="">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="fullname" value="<?=$admin['fullname']?>"  required  placeholder="Name Surname" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input id="pass2" type="password" value="<?=$admin['password']?>"  name="password" required placeholder="Password" class="form-control">
                                        </div>
                                    </div>
