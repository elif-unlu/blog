                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header" id="top">
                            <h2 class="pageheader-title">Blog Edit </h2>
                        ...
                        <div class=" editor">
                            <div class="col-md-12 p-0">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="summernote" name="text" rows="6" placeholder="Write Descriptions"><?=$blog['text']?></textarea>
                                </div>
                            </div>
